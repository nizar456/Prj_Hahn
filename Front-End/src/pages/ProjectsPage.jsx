    ...
    <div className="space-y-6 rounded-3xl border border-slate-800 bg-slate-900/70 p-8 shadow-2xl shadow-purple-900/30">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {projects.map((project) => (
          <div
            key={project.id}
            className="group flex flex-col gap-3 rounded-2xl border border-slate-800 bg-slate-950/60 p-5 transition hover:border-sky-400"
          >
            ...
            <div className="flex flex-wrap gap-2 text-xs font-semibold text-slate-200">
              <button
                ...
                className="rounded-full bg-sky-500 px-3 py-2 text-slate-950 shadow-sm shadow-sky-500/30 transition hover:bg-sky-400"
              >
                Voir les tâches
              </button>
              <button
                ...
                className="rounded-full border border-slate-700 px-3 py-2 text-slate-200 hover:border-sky-400"
              >
                Éditer
              </button>
              <button
